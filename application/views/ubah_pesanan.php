...
<html lang="id" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url().'css/upesan.css'; ?>">
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
  ...
  <body>
    ...
    <table class="center">
      <thead>
        <tr>
          <th scope="col"><?php echo str_repeat('&nbsp;', 15); ?>nama menu</td>
          <th scope="col">jumlah pesan</td>
          <th scope="col">harga satuan</td>
          <th scope="col">total harga</td>
          <th scope="col" colspan="2" style="text-align: center">aksi</td>
        </tr>
      </thead>
      <?php foreach ($data as $value): ?>
        <tr>
          <td scope="row"><?php echo str_repeat('&nbsp;', 15); ?><?php echo $value->nama_menu ?></td>
